...
assert((liveInstagram.content.match(/rrn-contract-recovery/g) || []).length === 1, 'live Instagram dialect produced fragmented recovery cards')
...
assert((liveTwitter.content.match(/rrn-contract-recovery/g) || []).length === 1, 'live loose Twitter dialect produced fragmented recovery cards')
...
assert((liveReddit.content.match(/rrn-contract-recovery/g) || []).length === 1, 'live Reddit dialect did not fail closed as one editable block')
...
assert((liveDiscord.content.match(/rrn-contract-recovery/g) || []).length === 1, 'live malformed Discord shape was falsely reported as rendered or fragmented')
