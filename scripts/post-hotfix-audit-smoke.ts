...
assert.equal(JSON.parse(readFileSync(new URL('../package.json', import.meta.url), 'utf8')).version, '0.2.8.7.15', 'audit follow-up version is not the authorized release')
