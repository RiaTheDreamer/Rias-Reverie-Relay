...
equal(pkg.version, '0.2.8.6.1')
equal(manifest.version, '0.2.8.6.1')
...
assert(frontend.includes("'.rrcp-presentation-sparkling > .rrcp-launch, .rrcp-presentation-plain > .rrcp-launch'") && frontend.includes("shell.style.setProperty('display', open ? 'block' : 'none', 'important')"), 'Character Phone outer launchers must receive host-safe interaction binding without changing supplied Regex styling')
