...
[data-reverie-glass-button]>summary::before,[data-reverie-glass-button]>summary::after{content:none!important;background:none!important;box-shadow:none!important}
...
[data-reverie-narrative-glass-button]>summary::before,[data-reverie-narrative-glass-button]>summary::after{content:none!important;background:none!important;box-shadow:none!important}
...
[data-reverie-narrative-glass-button]>summary [class*="spark"]>*,[data-reverie-narrative-glass-button]>summary [class*="particle"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="spark"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="particle"]>*{width:1px!important;height:1px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 20%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i:nth-child(n+9){display:none!important}
[data-reverie-narrative-glass-button].ch-og .ch-launch-emoji{display:none!important}
...
.${NARRATIVE_GLASS_SPARK_CLASS} i{--x:50%;--y:50%;--dx:0px;--dy:-28px;--dur:8s;--delay:0s;position:absolute!important;left:var(--x)!important;top:var(--y)!important;display:block!important;width:1px!important;height:1px!important;border-radius:999px!important;background:color-mix(in srgb,var(--lumiverse-primary,#d45b9f) 62%,transparent)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 20%,transparent)!important;opacity:0;animation:rrNarrativeGlassSpark var(--dur) ease-in-out var(--delay) infinite!important}
