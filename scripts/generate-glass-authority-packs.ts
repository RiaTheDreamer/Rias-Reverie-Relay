...
[data-reverie-glass-authority].r65>.r65-launch .r65-sparks i{width:1px!important;height:1px!important;background:color-mix(in srgb,var(--rr-glass-primary) 62%,transparent)!important;box-shadow:0 0 3px color-mix(in srgb,var(--rr-glass-primary) 20%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
...
[data-reverie-glass-button][data-reverie-glass-button]>summary::before,[data-reverie-glass-button][data-reverie-glass-button]>summary::after{content:none!important;background:none!important;box-shadow:none!important}
[data-reverie-glass-button]>summary [class*="spark"]>*,[data-reverie-glass-button]>summary [class*="particle"]>*{width:1px!important;height:1px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 20%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
...
@keyframes rrNarrativeGlassSpark{0%{opacity:0;transform:translate3d(0,9px,0) scale(.72)}20%{opacity:.58}56%{opacity:.78}100%{opacity:0;transform:translate3d(var(--dx,4px),var(--dy,-27px),0) scale(1.13)}}
[data-reverie-narrative-glass-button].r65.r65,[data-reverie-narrative-glass-button].ra66.ra66,[data-reverie-narrative-glass-button].rrcp-wrap.rrcp-wrap,[data-reverie-narrative-glass-button].ch-og.ch-og,[data-reverie-narrative-glass-button].dg-dramatic-cutaway.dg-dramatic-cutaway{margin:0 auto!important}
...
[data-reverie-narrative-glass-button]>summary [class*="spark"]>*,[data-reverie-narrative-glass-button]>summary [class*="particle"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="spark"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="particle"]>*{width:1.8px!important;height:1.8px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 74%,#fff 26%)!important;box-shadow:0 0 4px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 38%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(2),[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(5),[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(7),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(2),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(5),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(7){width:2.05px!important;height:2.05px!important;background:color-mix(in srgb,#fff 72%,var(--lumiverse-primary,#ff70bd) 28%)!important;box-shadow:0 0 4px color-mix(in srgb,#fff 30%,transparent)!important}
...
.${NARRATIVE_GLASS_SPARK_CLASS} i{--x:50%;--y:50%;--dx:0px;--dy:-28px;--dur:8s;--delay:0s;position:absolute!important;left:var(--x)!important;top:var(--y)!important;display:block!important;width:1.8px!important;height:1.8px!important;border-radius:999px!important;background:color-mix(in srgb,var(--lumiverse-primary,#d45b9f) 74%,#fff 26%)!important;box-shadow:0 0 4px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 38%,transparent)!important;opacity:0;animation:rrNarrativeGlassSpark var(--dur) ease-in-out var(--delay) infinite!important}
...
.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(2),.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(5),.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(7){width:2.05px!important;height:2.05px!important;background:color-mix(in srgb,#fff 72%,var(--lumiverse-primary,#d45b9f) 28%)!important;box-shadow:0 0 4px color-mix(in srgb,#fff 30%,transparent)!important}
@keyframes rrNarrativeGlassSpark{0%{opacity:0;transform:translate3d(0,10px,0) scale(.72)}18%{opacity:.58}55%{opacity:.78}100%{opacity:0;transform:translate3d(var(--dx),var(--dy),0) scale(1.13)}}
