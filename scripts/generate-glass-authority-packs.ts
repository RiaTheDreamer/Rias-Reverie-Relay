...
@keyframes rrAuthorityGlassSpark{0%{opacity:0;transform:translate3d(0,7px,0) scale(.8)}18%{opacity:.5}55%{opacity:.68}100%{opacity:0;transform:translate3d(var(--rr-glass-dx,5px),-25px,0) scale(1.02)}}
...
[data-reverie-glass-authority]>summary{border-color:color-mix(in srgb,var(--rr-glass-primary) 8%,transparent)!important;background:color-mix(in srgb,var(--rr-glass-deep) 4%,transparent)!important;-webkit-backdrop-filter:blur(9px) saturate(1.05);backdrop-filter:blur(9px) saturate(1.05);box-shadow:0 0 10px color-mix(in srgb,var(--rr-glass-primary) 3%,transparent)!important}
[data-reverie-glass-authority]>summary::before,[data-reverie-glass-authority]>summary::after{content:none!important;background:none!important;box-shadow:none!important}
...
[data-reverie-glass-authority].r65>.r65-launch .r65-sparks i{width:1.1px!important;height:1.1px!important;background:color-mix(in srgb,var(--rr-glass-primary) 70%,#fff 30%)!important;box-shadow:0 0 3px color-mix(in srgb,var(--rr-glass-primary) 62%,transparent),0 0 7px color-mix(in srgb,var(--rr-glass-primary) 24%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-glass-authority]>summary .r65-sparks i:nth-child(2),[data-reverie-glass-authority]>summary .r65-sparks i:nth-child(5),[data-reverie-glass-authority]>summary .r65-sparks i:nth-child(7){width:1.35px!important;height:1.35px!important;background:color-mix(in srgb,#fff 78%,var(--rr-glass-primary) 22%)!important;box-shadow:0 0 3px color-mix(in srgb,#fff 58%,transparent),0 0 7px color-mix(in srgb,#fff 28%,transparent)!important}
...
/* Every shipped Surface entry point is a Glass Button.  The compact App
   launchers are nested controls, not direct children of the outer Surface
   details, so they need the same trailing authority rather than their
   historical neon/opaque shell. */
[data-reverie-glass-button][data-reverie-glass-button]>summary,[data-reverie-glass-button] .dg-compact-launch{position:relative!important;z-index:2!important;isolation:isolate!important;display:flex!important;width:max-content!important;max-width:min(calc(100% - 24px),360px)!important;height:40px!important;min-height:40px!important;margin:14px auto 0!important;padding:0 20px!important;overflow:hidden!important;align-items:center!important;justify-content:center!important;cursor:pointer!important;pointer-events:auto!important;list-style:none!important;border:1px solid color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 10%,transparent)!important;border-radius:13px!important;background:color-mix(in srgb,var(--lumiverse-bg-deep,#0b0710) 4%,transparent)!important;color:var(--lumiverse-primary-text,var(--lumiverse-text,#f6f1f7))!important;font:800 10px/1 var(--lumiverse-font-mono,"Courier New",monospace)!important;letter-spacing:.18em!important;text-transform:uppercase!important;box-shadow:0 0 10px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 3%,transparent)!important;-webkit-backdrop-filter:blur(9px) saturate(1.05);backdrop-filter:blur(9px) saturate(1.05)}
[data-reverie-glass-button][data-reverie-glass-button]>summary::-webkit-details-marker,[data-reverie-glass-button] .dg-compact-launch::-webkit-details-marker{display:none!important}
[data-reverie-glass-button][data-reverie-glass-button]>summary::before,[data-reverie-glass-button][data-reverie-glass-button]>summary::after,[data-reverie-glass-button] .dg-compact-launch::before,[data-reverie-glass-button] .dg-compact-launch::after{content:none!important;background:none!important;box-shadow:none!important}
[data-reverie-glass-button]>summary [class*="spark"]>*,[data-reverie-glass-button]>summary [class*="particle"]>*,[data-reverie-glass-button] .dg-compact-launch [class*="spark"]>*,[data-reverie-glass-button] .dg-compact-launch [class*="particle"]>*{width:1.1px!important;height:1.1px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 70%,#fff 30%)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent),0 0 7px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 24%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-glass-button]>summary [class*="spark"]>*:nth-child(2),[data-reverie-glass-button]>summary [class*="spark"]>*:nth-child(5),[data-reverie-glass-button]>summary [class*="spark"]>*:nth-child(7),[data-reverie-glass-button]>summary [class*="particle"]>*:nth-child(2),[data-reverie-glass-button]>summary [class*="particle"]>*:nth-child(5),[data-reverie-glass-button]>summary [class*="particle"]>*:nth-child(7),[data-reverie-glass-button] .dg-compact-launch [class*="spark"]>*:nth-child(2),[data-reverie-glass-button] .dg-compact-launch [class*="spark"]>*:nth-child(5),[data-reverie-glass-button] .dg-compact-launch [class*="spark"]>*:nth-child(7),[data-reverie-glass-button] .dg-compact-launch [class*="particle"]>*:nth-child(2),[data-reverie-glass-button] .dg-compact-launch [class*="particle"]>*:nth-child(5),[data-reverie-glass-button] .dg-compact-launch [class*="particle"]>*:nth-child(7){width:1.35px!important;height:1.35px!important;background:color-mix(in srgb,#fff 78%,var(--lumiverse-primary,#ff70bd) 22%)!important;box-shadow:0 0 3px color-mix(in srgb,#fff 58%,transparent),0 0 7px color-mix(in srgb,#fff 28%,transparent)!important}
@media(prefers-reduced-motion:reduce){[data-reverie-glass-button]>summary [class*="spark"]>*,[data-reverie-glass-button]>summary [class*="particle"]>*,[data-reverie-glass-button] .dg-compact-launch [class*="spark"]>*,[data-reverie-glass-button] .dg-compact-launch [class*="particle"]>*{animation:none!important;opacity:.26!important}}
</style>`
...
[data-reverie-narrative-glass-button]>summary [class*="spark"]>*,[data-reverie-narrative-glass-button]>summary [class*="particle"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="spark"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="particle"]>*{width:1.1px!important;height:1.1px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 70%,#fff 30%)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent),0 0 7px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 24%,transparent)!important;animation:rrAuthorityGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(2),[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(5),[data-reverie-narrative-glass-button]>summary .rr-narrative-glass-sparks i:nth-child(7),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(2),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(5),[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch .rr-narrative-glass-sparks i:nth-child(7){width:1.35px!important;height:1.35px!important;background:color-mix(in srgb,#fff 78%,var(--lumiverse-primary,#ff70bd) 22%)!important;box-shadow:0 0 3px color-mix(in srgb,#fff 58%,transparent),0 0 7px color-mix(in srgb,#fff 28%,transparent)!important}
...
@media(prefers-reduced-motion:reduce){[data-reverie-narrative-glass-button]>summary [class*="spark"]>*,[data-reverie-narrative-glass-button]>summary [class*="particle"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="spark"]>*,[data-reverie-narrative-glass-button].rrcp-wrap>.rrcp-launch [class*="particle"]>*{animation:none!important;opacity:.26!important}}
</style>`

const NARRATIVE_GLASS_SPARK_CLASS = 'rr-narrative-glass-sparks'
const NARRATIVE_GLASS_SPARK_NODES = '<i></i><i></i><i></i><i></i><i></i><i></i><i></i><i></i>'
...
.${NARRATIVE_GLASS_SPARK_CLASS} i{--x:50%;--y:50%;--dx:0px;--dy:-28px;--dur:8s;--delay:0s;position:absolute!important;left:var(--x)!important;top:var(--y)!important;display:block!important;width:1.1px!important;height:1.1px!important;border-radius:999px!important;background:color-mix(in srgb,var(--lumiverse-primary,#d45b9f) 70%,#fff 30%)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent),0 0 7px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 24%,transparent)!important;opacity:0;animation:rrNarrativeGlassSpark var(--dur) ease-in-out var(--delay) infinite!important}
...
.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(2),.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(5),.${NARRATIVE_GLASS_SPARK_CLASS} i:nth-child(7){width:1.35px!important;height:1.35px!important;background:color-mix(in srgb,#fff 78%,var(--lumiverse-primary,#d45b9f) 22%)!important;box-shadow:0 0 3px color-mix(in srgb,#fff 58%,transparent),0 0 7px color-mix(in srgb,#fff 28%,transparent)!important}
@keyframes rrNarrativeGlassSpark{0%{opacity:0;transform:translate3d(0,10px,0) scale(.8)}18%{opacity:.5}55%{opacity:.68}100%{opacity:0;transform:translate3d(var(--dx),var(--dy),0) scale(1.02)}}
