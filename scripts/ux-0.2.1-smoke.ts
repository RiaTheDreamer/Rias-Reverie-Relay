...
assert(manifest.previous_identifiers?.includes('dreamglass_image_router'), 'manifest must migrate the original public identifier')
assert(manifest.previous_identifiers?.includes('reverie__relay'), 'manifest must repair the doubled-underscore installation identity')
