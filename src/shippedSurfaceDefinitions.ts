...
const LEGACY_SHIPPED_SURFACE_SPECS: ShippedSurfaceSpec[] = [
        ...
        },
  {
          ...
          requiredMediaCount: 1,
          sampleXml: "<imessage_chat title=\"Weekend Survivors\" participants=\"current character, other participant, additional participant, You\" time=\"Today 7:14 PM\" status=\"Delivered\" unread=\"0\">\n<im_messages>\n<im_msg from=\"current character\" side=\"left\">Message.</im_msg>\n<im_msg from=\"You\" side=\"right\">Reply.</im_msg>\n<im_media>\n<image_request id=\"imessage-chat-001\" target=\"custom.imessage-chat\" slot=\"shared-image\" aspect=\"16:9\" alt=\"Shared iMessage photograph\">\n<scene_brief>A wide shared photograph shown inside the chat. Preserve the full composition in a contained wide frame.</scene_brief>\n</image_request>\n</im_media>\n<im_msg from=\"additional participant\" side=\"left\">Message after the image.<im_reaction>😂 4</im_reaction></im_msg>\n<im_system>Group name changed.</im_system>\n</im_messages>\n<details><summary>Group information</summary><im_group_info><im_member>current character</im_member><im_member>other participant</im_member><im_member>additional participant</im_member><im_member>You</im_member></im_group_info></details>\n</imessage_chat>",
          promptModule: "SURFACE: IMESSAGE GROUP CHAT\nUse <imessage_chat> with target=\"custom.imessage-chat\". Include 1 complete image request in authored order, using unique ids, meaningful slots, accessible alt text, aspect 16:9, and visible scene briefs. Place readable interface text in the semantic child tags.\n\nCONTRACT EXAMPLE\n<imessage_chat title=\"Weekend Survivors\" participants=\"current character, other participant, additional participant, You\" time=\"Today 7:14 PM\" status=\"Delivered\" unread=\"0\">\n<im_messages>\n<im_msg from=\"current character\" side=\"left\">Message.</im_msg>\n<im_msg from=\"You\" side=\"right\">Reply.</im_msg>\n<im_media>\n<image_request id=\"imessage-chat-001\" target=\"custom.imessage-chat\" slot=\"shared-image\" aspect=\"16:9\" alt=\"Shared iMessage photograph\">\n<scene_brief>A wide shared photograph shown inside the chat. Preserve the full composition in a contained wide frame.</scene_brief>\n</image_request>\n</im_media>\n<im_msg from=\"additional participant\" side=\"left\">Message after the image.<im_reaction>😂 4</im_reaction></im_msg>\n<im_system>Group name changed.</im_system>\n</im_messages>\n<details><summary>Group information</summary><im_group_info><im_member>current character</im_member><im_member>other participant</im_member><im_member>additional participant</im_member><im_member>You</im_member></im_group_info></details>\n</imessage_chat>",
          category: "social-messaging",
          shellMode: "collapsible",
          maxWidth: "460px",
          mediaFit: "contain",
        ...
        },
  {
          ...
          requiredMediaCount: 1,
          sampleXml: "<workspace_chat workspace=\"Expedition Team\" channel=\"field-chat\" topic=\"Coordination and live updates\" members=\"5\" time=\"11:36 PM\">\n<ws_messages>\n<ws_msg user=\"current character\" time=\"11:32 PM\">Message.</ws_msg>\n<ws_msg user=\"other participant\" time=\"11:33 PM\">Reply.</ws_msg>\n<ws_msg user=\"current character\" time=\"11:33 PM\">Shared image:<ws_media>\n<image_request id=\"workspace-chat-001\" target=\"custom.workspace-chat\" slot=\"shared-media\" aspect=\"16:9\" alt=\"Workspace shared image\">\n<scene_brief>A full uncropped shared image relevant to the channel conversation.</scene_brief>\n</image_request>\n</ws_media></ws_msg>\n<ws_msg user=\"additional participant\" time=\"11:35 PM\">Voice upload.<ws_voice>▶ 00:31</ws_voice></ws_msg>\n</ws_messages>\n<details><summary>Members</summary><ws_members><ws_member>current character</ws_member><ws_member>other participant</ws_member><ws_member>additional participant</ws_member><ws_member>You</ws_member></ws_members></details>\n</workspace_chat>",
...
const R45_SAMPLE_OVERRIDES: Record<string, string> = {
  ...
  'imessage-chat': '<imessage_chat title="Weekend Group" participants="current character, other participant, You" time="Today 7:14 PM" status="Delivered" unread="0"><im_messages><im_msg from="current character" side="left">Are you there?</im_msg><im_msg from="You" side="right">Almost.</im_msg><im_media><image_request id="imessage-media-1" target="custom.artifact-media" slot="imessage-media-1" aspect="4:3" alt="Shared iMessage photograph"><scene_brief>Landscape phone photograph of the station entrance at dusk, entrance and surroundings fully visible, no phone UI or readable text.</scene_brief></image_request></im_media><im_msg from="other participant" side="left">I recognize that entrance.</im_msg></im_messages></imessage_chat>',
  'workspace-chat': '<workspace_chat workspace="Field Team" members="5" time="11:36 PM" active="1"><ws_channels><ws_channel slot="1" name="field-chat" description="Live coordination"><ws_messages><ws_msg user="current character" time="11:32 PM">Check the north gate.</ws_msg><ws_msg user="other participant" time="11:33 PM">Uploading the photograph.<ws_media><image_request id="workspace-media-1" target="custom.artifact-media" slot="workspace-media-1" aspect="4:3" alt="Workspace shared photograph"><scene_brief>Documentary photograph of the north gate being discussed, entire gate visible, no workspace UI or readable text.</scene_brief></image_request></ws_media></ws_msg></ws_messages></ws_channel><ws_channel slot="2" name="evidence" description="Reviewed evidence"><ws_messages><ws_msg user="additional participant" time="11:34 PM">File received.</ws_msg></ws_messages></ws_channel><ws_channel slot="3" name="planning" description="Next actions"><ws_messages><ws_msg user="current character" time="11:35 PM">Meet at dawn.</ws_msg></ws_messages></ws_channel><ws_channel slot="4" name="archive" description="Older updates"><ws_messages><ws_msg user="other participant" time="11:36 PM">Archived.</ws_msg></ws_messages></ws_channel></ws_channels></workspace_chat>',
