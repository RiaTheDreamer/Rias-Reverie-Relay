...
[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i{width:1.8px!important;height:1.8px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 74%,#fff 26%)!important;box-shadow:0 0 4px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 38%,transparent)!important;animation:rrNarrativeGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i:nth-child(2),[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i:nth-child(5),[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i:nth-child(7){width:2.05px!important;height:2.05px!important;background:color-mix(in srgb,#fff 72%,var(--lumiverse-primary,#ff70bd) 28%)!important;box-shadow:0 0 4px color-mix(in srgb,#fff 30%,transparent)!important}
