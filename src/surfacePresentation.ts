...
[data-reverie-narrative-glass-button] .rr-narrative-glass-sparks i{width:1px!important;height:1px!important;background:color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 62%,transparent)!important;box-shadow:0 0 3px color-mix(in srgb,var(--lumiverse-primary,#ff70bd) 20%,transparent)!important;animation:rrNarrativeGlassSpark var(--dur,9s) ease-in-out var(--delay,0s) infinite!important}
